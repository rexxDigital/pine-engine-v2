...
namespace Editor::Gui::HotkeyManager
{

	uint32_t RegisterHotkey( const std::string& name, int defaultKey, bool ctrl, bool alt );
	
	bool GetHotkeyPressed( uint32_t hotkey );
